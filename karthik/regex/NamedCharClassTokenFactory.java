 ...
 * @author karthik
 */
class NamedCharClassTokenFactory // creates character class regex token for named POSIX classes
{

    static CharClassRegexToken getCharClassToken(final String class_name,
        final boolean isNegated, int flags)
